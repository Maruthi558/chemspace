...
const NAV_ITEMS = [
  { to: '/', label: 'Overview', icon: Home, badge: 'Hub', formula: 'CHEMNOVA', desc: 'System Hub' },
  { to: '/chemdraw', label: 'ChemDraw Studio', icon: PenTool, badge: '2D/3D', formula: 'CH₃-C(=O)OH', desc: 'CAD Sketcher' },
  { to: '/rdkit-lab', label: 'RDKit Lab', icon: Cpu, badge: 'Python', formula: 'C₉H₈O₄', desc: 'Cheminformatics' },
  { to: '/spectroscopy', label: 'Spectroscopy', icon: Radio, badge: 'Spectra', formula: 'C=O • δ 2.1', desc: 'FTIR • NMR • MS' },
  { to: '/chromatography', label: 'Chromatography', icon: FlaskConical, badge: 'HPLC/GC', formula: 'Rf • tR • N', desc: 'Separation Science' },
  { to: '/quantum-library', label: 'Quantum VQE', icon: Zap, badge: 'DFT', formula: 'ΔE (HOMO-LUMO)', desc: 'Electronic Structure' },
  { to: '/ibm-rxn', label: 'IBM RXN Studio', icon: Activity, badge: 'Synthesis', formula: 'R-COOH + R\'-OH', desc: 'Retrosynthesis' },
  { to: '/periodic-table', label: 'Periodic Table', icon: Grid, badge: '118 El', formula: 'H¹ → Og¹¹⁸', desc: 'Mendeleev Grid' },
  { to: '/scientists', label: 'Discoveries', icon: Award, badge: 'Nobel', formula: '1834 → 2026', desc: 'History & Pioneers' },
];
          ...
          <div className="pt-1">
            {user ? (
              <div className={`p-2.5 rounded-2xl border flex items-center justify-between gap-2 ${
                ...
                >
                  <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-cyan-400 to-violet-500 p-0.5 shadow-md shrink-0 flex items-center justify-center text-white font-black text-xs">
                    {user.avatar ? (
